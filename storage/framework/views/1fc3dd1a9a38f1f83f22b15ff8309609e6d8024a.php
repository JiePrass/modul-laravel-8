...
<head>
    ...
    <title>Laravel 8 | <?php echo $__env->yieldContent('title'); ?></title>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo e(asset('adminLTE')); ?>/dist/img/user2-160x160.jpg"
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo e(asset('adminLTE')); ?>/dist/img/user2-160x160.jpg" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo e(asset('adminLTE')); ?>/dist/img/user2-160x160.jpg" class="img-circle"
                                        alt="User Image">
                                    <p>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <form action="<?php echo e(route('logout')); ?>" class="d-none" id="logout-form"
                                            method="post">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\bab5-18\resources\views/layout/v_template.blade.php ENDPATH**/ ?>